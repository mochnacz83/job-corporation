...
import { ArrowLeft, ShieldCheck, Save, Loader2, BarChart3, LayoutDashboard, RefreshCw, CalendarDays, ClipboardList, ClipboardCheck, Boxes, CheckCircle2, FileSpreadsheet, Wrench, Radar } from "lucide-react";
...
const AVAILABLE_MODULES = [
    ...
    { id: "concentracao_reparos", label: "Concentração de Reparos", icon: Wrench },
