-- Corrigir UPDATE policy em material_coletas para permitir o usuário travar (post_edit_locked=true)
-- USING valida o estado atual; WITH CHECK só exige posse, não impede setar locked=true.
